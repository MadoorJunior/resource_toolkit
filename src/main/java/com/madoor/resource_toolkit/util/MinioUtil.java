...
public class MinioUtil {
     ...
     * @param bucketName  存储桶名称
     * @param file        文件名
     * @param originalName  对象名
     * @return ObjectWriteResponse对象
     */
    public static ObjectWriteResponse uploadFile(String bucketName, MultipartFile file, String originalName, String keyName) throws Exception {
        InputStream inputStream = file.getInputStream();
        Optional<MediaType> optional = MediaTypeFactory.getMediaType(originalName);
     ...
     * @param inputStream 文件流
     */
    public static ObjectWriteResponse uploadPreview(String bucketName, String objectName, InputStream inputStream) throws Exception {
        PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
     ...
     * @param inputStream 文件流
     */
    public static ObjectWriteResponse uploadThumbImg(String bucketName, String objectName, InputStream inputStream) throws Exception {
        PutObjectArgs putObjectArgs = PutObjectArgs.builder()
                .bucket(bucketName)
                .object(objectName)
